          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                {navigation.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="text-sm/6 font-semibold text-gray-900 px-2 pb-1 hover:border-b-2 hover:border-blue-500 transition duration-200"
                  >
                    {item.name}
                  </a>
                ))}
              ...
              <div className="py-6">
                <a
                  href="#"
                  className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:border-b-2 hover:border-blue-500 transition duration-200"
                >
                  Log in
                </a>
              </div>
